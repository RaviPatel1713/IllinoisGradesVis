...
const Signup = () => {
    ...
    // state variables and its setState functions using React hook 
    ...
    const onSubmit = async (e) => {
        ...
        await createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                console.log(`USER-NAME: ${firstName} USER-LASTNAME: ${lastName}`);
                ...
                .catch((err) => {
                    console.log("Error: " + err + "\n-- User must login to access the profile right after registration");
                });
                // ...
            })
            .catch((error) => {
